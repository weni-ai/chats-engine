...
CALLBACK_RETRYABLE_STATUS_CODES = env.list(
    ...
    default=[408, 429, 500, 502, 503, 504, 507, 509, 510, 511],
    cast=int,
)
CALLBACK_NON_RETRYABLE_STATUS_CODES = env.list(
    "CALLBACK_NON_RETRYABLE_STATUS_CODES",
    default=[400, 401, 403, 404, 405, 422],
    cast=int,
)
CALLBACK_RETRY_COUNT = env.int("CALLBACK_RETRY_COUNT", default=5)
CALLBACK_RETRY_BACKOFF_FACTOR = env.float("CALLBACK_RETRY_BACKOFF_FACTOR", default=0.5)
CALLBACK_TIMEOUT_SECONDS = env.int("CALLBACK_TIMEOUT_SECONDS", default=30)
...
TOKEN_CACHE_TTL = env.int("TOKEN_CACHE_TTL", default=900)  # 15 min default
USER_EMAIL_CACHE_TTL = env.int("USER_EMAIL_CACHE_TTL", default=1800)  # 30 min default

# Circuit Breaker configurations
CIRCUIT_BREAKER_FAILURE_THRESHOLD = env.int("CIRCUIT_BREAKER_FAILURE_THRESHOLD", default=5)
CIRCUIT_BREAKER_RECOVERY_TIMEOUT = env.int("CIRCUIT_BREAKER_RECOVERY_TIMEOUT", default=60)
KEYCLOAK_CIRCUIT_BREAKER_THRESHOLD = env.int("KEYCLOAK_CIRCUIT_BREAKER_THRESHOLD", default=3)
KEYCLOAK_CIRCUIT_BREAKER_TIMEOUT = env.int("KEYCLOAK_CIRCUIT_BREAKER_TIMEOUT", default=120)
