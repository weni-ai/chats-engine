...
class TestProjectPermissionConsumer(TestCase):
    def setUp(self):
        ...
        self.mock_message.body = b'{"project": "test_project", "user": "test_user", "role": "admin"}'

    @mock.patch('chats.apps.projects.consumers.permission_consumer.ProjectPermissionCreationUseCase')
    ...
    def test_consume_invalid_json(self, mock_use_case):
        ...
        self.mock_channel.basic_reject.assert_called_once_with("test_delivery_tag", requeue=False)
